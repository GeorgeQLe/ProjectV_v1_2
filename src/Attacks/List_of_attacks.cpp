/*  Copyright 2017 George Le
    Definitions of member functions of the List_of_attacks struct
*/
#include <iostream>
#include "Attacks/List_of_attacks.h"

List_of_attacks::List_of_attacks() 
        : m_primary_attack("Shoot", 0, 0, 0, true), pm_ult(new Default_ult_attack()),
...
List_of_attacks::List_of_attacks(std::vector<std::string> list_of_attack_names) 
    : m_primary_attack(list_of_attack_names.at(0), 0, 0, 0, true), pm_ult(new Default_ult_attack(list_of_attack_names.at(1), 0, 0, 0, false)),
