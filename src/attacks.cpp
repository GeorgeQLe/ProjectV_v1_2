...
{
    m_ult = new Ultimate_attacks("Spray and pay", 0, 0, 0, false);
    m_use_offensive_item = new Item_attack("Potion", 0, 0, 0, false);
    
    // adds the names of the various attacks to the vector
    m_list_of_attack_names.push_back(m_primary_attack.get_name());
    m_list_of_attack_names.push_back(m_ult->get_name());
    m_list_of_attack_names.push_back(m_use_offensive_item->get_name());
...
{
    m_ult = new Ultimate_attacks(list_of_attack_names.at(1), 0, 0, 0, false);
    m_use_offensive_item = new Item_attack(list_of_attack_names.at(2), 0, 0, 0, false);
